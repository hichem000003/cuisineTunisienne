 ...
 */
final class Version20210724202156 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recette (id INT AUTO_INCREMENT NOT NULL, nom_recette VARCHAR(255) NOT NULL, temps_cuisson TIME NOT NULL, temps_preparation TIME NOT NULL, photo VARCHAR(255) DEFAULT NULL, video VARCHAR(255) DEFAULT NULL, nb_personnes INT NOT NULL, niveau_difficulte INT NOT NULL, ref_recette VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
